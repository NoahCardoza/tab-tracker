  ...
  <el-row style="border-bottom: solid 1px #e6e6e6;">
    ...
    <el-col class="long-col" style="float: right;" :span="22">
      <el-menu style="border-bottom: none;" :default-active="$route.path" mode="horizontal" router>
        ...
        <el-menu-item v-if="!$store.state.loggedIn" index="/login">Login</el-menu-item>
        <el-menu-item v-if="!$store.state.loggedIn" index="/register">Register</el-menu-item>
        <el-menu-item v-if="$store.state.loggedIn" index="/songs">Songs</el-menu-item>
        <el-menu-item v-if="$store.state.loggedIn" index="/" @click="logout">Logout</el-menu-item>
      </el-menu>
    </el-col>
  </el-row>
</template>
